...
export const run6551NFTChatUseCases = async (): Promise<void> => {
  console.log(`
    ░█████╗░███████╗███████╗░░███╗░░░░░███╗░░██╗███████╗████████╗░░░░█████╗░██╗░░██╗░█████╗░████████╗
    ██╔═══╝░██╔════╝██╔════╝░████║░░░░░████╗░██║██╔════╝╚══██╔══╝░░░██╔══██╗██║░░██║██╔══██╗╚══██╔══╝
    ██████╗░██████╗░██████╗░██╔██║░░░░░██╔██╗██║█████╗░░░░░██║░░░░░░██║░░╚═╝███████║███████║░░░██║░░░
...
async function PushAPI_nft_user_create(silent = !showAPIResponse) {
  ...
  //   env: env as ENV,
  // });
  user1 = await PushAPI.user.create({
    account: nftAccount1,
    version,
    signer: nftSigner1,
    env: env as ENV,
  ...
  // let user2 = await PushAPI.user.get({
  //   account: nftAccount2,
  //   env: env as ENV,
  // });
  // if (!user2 || !user2.encryptedPrivateKey) {
  //   user2 = await PushAPI.user.create({
  //     account: nftAccount2,
  //     version,
  //     signer: nftSigner2,
  //     env: env as ENV,
