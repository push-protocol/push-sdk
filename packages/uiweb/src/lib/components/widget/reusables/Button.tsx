/**
 * @file Button
 * generic button component for widget
 ...
 * @property {IWidgetTheme} [theme] - The theme for the button. Optional.
...
/* styling */
const WidgetButton = styled.button<IButtonProps>`
  display: flex;
  ...
  gap:'2px' ;
  padding: ${(props) =>
    props.customStyle?.padding ? props.customStyle.padding : '12px'};
