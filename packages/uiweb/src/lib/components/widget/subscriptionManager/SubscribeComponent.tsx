...
const SubHeadingText = {
  withSettings: 'Select which setting list you would like to receive notifications from.',
  withoutSettings: 'Subscribe and receive notifications from your favorite protocol.',
};
...
export const SubscribeComponent: React.FC<ISubscribeComponentProps> = (options: ISubscribeComponentProps) => {
  const { channelInfo, handleNext, channelAddress, autoconnect = false } = options || {};
  const { subscribeToChannel, subscribeError, subscribeLoading, setSubscribeError } = useManageSubscriptionsUtilities();
