...
export const CreateGroupType = ({
  ...
  const createGroupService = async () => {
    ...
    alert("group created")
    console.log('created group with');
    onClose();
  };
