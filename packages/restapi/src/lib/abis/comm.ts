export default [
    {
      "anonymous": false,
      "inputs": [
        { "indexed": false, "internalType": "address", "name": "channel", "type": "address" },
    ...
    },
    {
      "anonymous": false,
      "inputs": [
        { "indexed": false, "internalType": "string", "name": "_chainName", "type": "string" },
        { "indexed": true, "internalType": "uint256", "name": "_chainID", "type": "uint256" },
        { "indexed": true, "internalType": "address", "name": "_channelOwnerAddress", "type": "address" },
        { "indexed": false, "internalType": "string", "name": "_ethereumChannelAddress", "type": "string" }
      ],
      "name": "ChannelAlias",
      "type": "event"
    },
    ...
    },
    {
      ...
      "inputs": [
        ...
        { "indexed": false, "internalType": "uint256", "name": "_notifID", "type": "uint256" },
    ...
    {
      "inputs": [{ "internalType": "address[]", "name": "_channelList", "type": "address[]" }],
      "name": "batchSubscribe",
    ...
    { "inputs": [], "name": "completeMigration", "outputs": [], "stateMutability": "nonpayable", "type": "function" },
    {
      "inputs": [
    ...
    {
      "inputs": [{ "internalType": "string", "name": "_channelAddress", "type": "string" }],
