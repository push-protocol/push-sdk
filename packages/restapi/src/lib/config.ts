...
const CONFIG = {
  ...
  [ENV.STAGING]: {
    ...
    [BLOCKCHAIN_NETWORK.SHARDEUM_TESTNET]: {
      API_BASE_URL: API_BASE_URL[ENV.STAGING],
      EPNS_COMMUNICATOR_CONTRACT: '0x3a680290a18f3000973d04d6d1c6f91a7294f27a'
    }
  },
  [ENV.DEV]: {
    [BLOCKCHAIN_NETWORK.ETH_SEPOLIA]: {
