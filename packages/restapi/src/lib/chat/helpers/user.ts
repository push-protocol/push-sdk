...
import { get, createUserCore, getV2 } from '../../user';
...
export const getConnectedUserV3 = async (
  wallet: walletType,
  privateKey: string | null,
  env: ENV
): Promise<IConnectedUser> => {
  return await getConnectedUserV3Core(wallet, privateKey, env, PGPHelper);
};

export const getConnectedUserV3Core = async (
  wallet: walletType,
  privateKey: string | null,
  env: ENV,
  pgpHelper: IPGPHelper
