...
export const MediaHelper = {
  ...
  getTempSaveLocation: function (fileURL: string) {
    return FileSystem.documentDirectory + this.getSaveFileName(fileURL, true);
  },
  // To get Actual Save Location
  getActualSaveLocation: function (fileURL: string) {
    return FileSystem.documentDirectory + this.getSaveFileName(fileURL, false);
  },
  ...
  isMediaSupportedVideo: function (fileURL: string) {
    ...
    if (this.isMediaExternalEmbed(fileURL)) {
      return true;
    } else {
  ...
  isMediaExternalEmbed: function (fileURL: string) {
    return this.isMediaYoutube(fileURL);
  },
