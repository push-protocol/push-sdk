    ...
    <div>
      ...
      <Section>
        <SectionItem>
          ...
          <input type="text" onChange={updateAliasAddr} value={aliasAddr} style={{ width: 400, height: 30 }} />
          ...
          />
          <SectionButton onClick={testGetAliasInfo}>get alias info</SectionButton>
        </SectionItem>
 
        {aliasData ? (
          <CodeFormatter>
            {JSON.stringify(aliasData, null, 4)}
          </CodeFormatter>
        ) : null}
      </Section>
    </div>
